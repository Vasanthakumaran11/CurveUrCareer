...
import { Download, TrendingUp, Award, Building2, Map, Brain, AlertCircle, CheckCircle } from 'lucide-react';
...
const ResultsDashboard = () => {
  ...
  // Mark assessment as saved locally when results are complete
  useEffect(() => {
