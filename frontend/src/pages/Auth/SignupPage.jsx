...
import { User, Mail, Lock, AlertCircle, ArrowRight, Eye, EyeOff, Sparkles, Users, TrendingUp, Compass } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 font-sans">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #1d0947 0%, #0a0220 100%)',
        }}
      >
        {/* Glow Effects */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_40%,rgba(139,92,246,0.12),transparent_50%)] pointer-events-none" />
        ...
        >
          ...
          <path d="M800,250 C700,200 500,160 400,80 C300,0 200,-40 100,-80" stroke="rgba(167, 139, 250, 0.3)" strokeWidth="1" filter="url(#glow-purple)" />
          <path d="M800,250 C740,180 580,120 440,60 C300,-10 240,-40 140,-80" stroke="rgba(167, 139, 250, 0.4)" strokeWidth="1.5" filter="url(#glow-purple)" />
          <path d="M800,250 C770,140 680,80 480,40 C300,0 180,-15 80,-40" stroke="rgba(167, 139, 250, 0.2)" strokeWidth="0.8" opacity="0.6" />
          <path d="M800,250 C710,320 580,360 380,380 C180,400 80,420 -20,440" stroke="rgba(167, 139, 250, 0.35)" strokeWidth="1.2" filter="url(#glow-purple)" />
          <path d="M800,250 C730,350 630,420 480,460 C330,500 180,540 30,580" stroke="rgba(167, 139, 250, 0.25)" strokeWidth="1" filter="url(#glow-purple)" />
          <path d="M800,250 C750,380 680,480 530,540 C380,600 230,650 80,670" stroke="rgba(167, 139, 250, 0.45)" strokeWidth="1.6" filter="url(#glow-purple)" />
        ...
        {/* Decorative Plants SVG Overlay (Purple) */}
        <svg
          className="absolute bottom-0 left-0 w-56 h-56 pointer-events-none opacity-40 text-[#2e1065]"
          viewBox="0 0 200 200"
          fill="currentColor"
        >
        ...
        <div className="relative z-10 flex items-center gap-3">
          <svg className="w-10 h-10" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="100" height="100" rx="28" fill="url(#logoGradPurple)" />
        ...
        <div className="relative z-10 px-8 flex-1 flex flex-col justify-center my-6">
          ...
          >
            <h2 className="text-white font-extrabold text-4xl leading-tight mb-4">
              ...
              <span className="text-[#a78bfa]">with CurveUrCareer.</span>
            </h2>
            <p className="text-violet-100/80 text-sm leading-relaxed max-w-sm">
              Create your free account to unlock courses, track your skills, and map your career roadmap.
            </p>
          </motion.div>
        ...
        <div className="relative z-10 grid grid-cols-3 gap-4 w-full">
          {stats.map(({ icon: Icon, value, label }, i) => (
            ...
            >
              ...
              <span className="text-violet-200/60 text-[10px] uppercase tracking-wider mt-1">{label}</span>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      {/* ── RIGHT FORM PANEL ── */}
      <div className="flex-1 flex flex-col justify-center items-center bg-slate-50 px-6 py-8 relative min-h-screen">
        {/* Mobile logo */}
        ...
        <motion.div
          ...
          className="w-full max-w-[480px] bg-white rounded-[2rem] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-slate-100/50 my-6"
        >
          {/* Heading */}
          <div className="mb-6">
            <p className="text-xs font-bold uppercase tracking-wider text-[#7c3aed] mb-1.5">Join the community</p>
            <h1 className="text-3xl font-extrabold text-slate-900 leading-tight tracking-tight">
              Create your free account
            </h1>
            <p className="text-slate-500 mt-2 text-sm">
              Already have an account?{' '}
              <Link to="/login" className="font-bold text-[#7c3aed] hover:underline transition-colors">
                Sign in
              </Link>
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">or sign up with email</span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-[#7c3aed] transition-all text-slate-800 text-sm shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-12 py-3 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-[#7c3aed] transition-all text-slate-800 text-sm shadow-sm"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-2 pt-2">
              <input
                ...
                className="w-4 h-4 text-[#7c3aed] border-slate-300 rounded focus:ring-violet-500/20"
              />
              <label htmlFor="agree-checkbox" className="text-xs text-slate-600 select-none">
                I agree to the{' '}
                <a href="#" className="font-semibold text-[#7c3aed] hover:underline">Terms of Service</a>{' '}
                and{' '}
                <a href="#" className="font-semibold text-[#7c3aed] hover:underline">Privacy Policy</a>.
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-white transition-all duration-300 bg-[#7c3aed] hover:bg-[#6d28d9] shadow-lg shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/30 overflow-hidden mt-6 text-sm"
            >
              {loading ? (
                <>
        ...
        {/* Footer */}
        <p className="mt-6 text-center text-xs text-slate-500 leading-relaxed max-w-[320px]">
